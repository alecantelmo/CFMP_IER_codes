...
%         names={'pert1','pert2','pert3','pert4','pert5','tp1','tp2','tp3','smol1','smol2','smol3'};
        ...
        for i=1:length(names)
           ...
           logsoebstarbackz_nodis(1,1:99)=logsoebstarbackz(1,1:99);
            ...
            for iii=100:120
            logy_nodis(1,iii)=logy_nodis(1,iii-1)+loghatz(1,99);
            logc_nodis(1,iii)=logc_nodis(1,iii-1)+loghatz(1,99);
            logx_nodis(1,iii)=logx_nodis(1,iii-1)+loghatz(1,99);
            logsoeexpz_nodis(1,iii)=logsoeexpz_nodis(1,iii-1)+loghatz(1,99);
            logsoeimpz_nodis(1,iii)=logsoeimpz_nodis(1,iii-1)+loghatz(1,99);
            lognetexpz_nodis(1,iii)=lognetexpz_nodis(1,iii-1)+loghatz(1,99);
            logsoebstarbackz_nodis(1,iii)=logsoebstarbackz_nodis(1,iii-1)+loghatz(1,99);
            end
...
%         time=0:length(tvec)-1;
        ...
        labor_dev_tp3(1,iii)=(labor_tp3(1,iii)-labor_tp3(1,1))*100;
        ...
        xlim([0 20])
        saveas(gcf,'disaster_baseline_new.fig')
