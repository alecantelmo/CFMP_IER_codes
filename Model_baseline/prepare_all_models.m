...
%     'RBC_EZ_adjCost_Calvo_Taylor2_shock2'; %Alessandro 06/09/19
...
if do_all_solutions==0
    ...
    Orders_for_TaylorProjection=[1,2,3];
    Orders_for_Smolyak=[];%[1,2]; %Alessandro 06/09/19
end

do_pert=1; % prepare perturbation
do_tp=1; % prepare Taylor projection
do_smol=0;%1; % prepare Smolyak collocation %Alessandro 06/09/19
